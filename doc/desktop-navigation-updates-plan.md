...
- [x] Delivery: Python/Rust/frontend tests and builds, native/browser inspection; Mac packages and Windows CI; version bump, docs, source push and signed release/channel publication. Runtime limitations and the Mac relaunch observation are recorded in `desktop-0.3.1-validation.md`.
